...
**Goal:** Build the first Moonwing slice on the operator’s designated manager host with a Clearwing-backed control API, worker execution for `network_scan` and `source_hunt`, Postgres as system of record, and local S3-compatible storage for artifacts.
...
- Your Ansible repo (outside this fork): inventory `hosts.yml` with a `moonwing_manager` (or similarly named) group/host.
  - Point `ansible_host` at reachable manager IPs/ DNS names (do **not** commit real addresses to public branches).
- Role or playbook that applies `deploy/ansible` (this repo) or your own Compose stack definitions.
  - Replace OpenVAS-focused stacks with Moonwing dependencies as needed.
- Role `tasks/main.yml` (or equivalent)
...
- Create: `./src/moonwing/__init__.py`
- Create: `./src/moonwing/config.py`
...
**Files:**
- Create: `./src/moonwing/core/job_types.py`
- Create: `./src/moonwing/core/providers.py`
- Create: `./src/moonwing/core/runtime_profiles.py`
- Create: `./src/moonwing/core/findings.py`
...
**Files:**
- Create: `./src/moonwing/db/base.py`
- Create: `./src/moonwing/db/session.py`
- Create: `./src/moonwing/db/models/user.py`
- Create: `./src/moonwing/db/models/credential.py`
- Create: `./src/moonwing/db/models/runtime_profile.py`
- Create: `./src/moonwing/db/models/target.py`
- Create: `./src/moonwing/db/models/artifact.py`
- Create: `./src/moonwing/db/models/run.py`
- Create: `./alembic.ini`
- Create: `./alembic/env.py`
- Create: `./alembic/versions/20260421_01_initial_schema.py`
- Test: `./tests/integration/test_initial_schema.py`
...
**Files:**
- Create: `./src/moonwing/services/credentials.py`
- Create: `./src/moonwing/schemas/credentials.py`
- Create: `./src/moonwing/schemas/runtime_profiles.py`
- Test: `./tests/unit/test_selection_rules.py`
...
**Files:**
- Create: `./src/moonwing/services/artifacts.py`
- Create: `./src/moonwing/schemas/artifacts.py`
- Test: `./tests/unit/test_artifact_provenance.py`
...
**Files:**
- Create: `./src/moonwing/services/runs.py`
- Create: `./src/moonwing/schemas/runs.py`
...
**Files:**
- Create: `./src/moonwing/api/main.py`
- Create: `./src/moonwing/api/routes/credentials.py`
- Create: `./src/moonwing/api/routes/runtime_profiles.py`
- Create: `./src/moonwing/api/routes/targets.py`
- Create: `./src/moonwing/api/routes/runs.py`
- Create: `./src/moonwing/api/routes/findings.py`
- Test: `./tests/integration/test_api_runs.py`
...
**Files:**
- Create: `./src/moonwing/worker/main.py`
- Create: `./src/moonwing/worker/tasks.py`
- Create: `./src/moonwing/worker/clearwing_runner.py`
- Test: `./tests/unit/test_worker_runner.py`
...
**Files:**
- Create: `./src/moonwing/services/normalization.py`
...
- Modify: `./src/moonwing/services/runs.py`
- Modify: `./src/moonwing/worker/tasks.py`
- Test: `./tests/integration/test_run_execution_flow.py`
...
## Task 11: Ansible / Compose deployment integration

**Files:**
- Modify: Ansible inventory defining your manager host (see `./deploy/ansible/inventory/` for placeholders).
- Modify: Compose stack/service definitions consumed by your roles (or delegate to `./deploy/ansible`).
- Create: Env files or templates for Moonwing secrets (never commit live values).
- Test: deployment verification notes in `./README.md`
...
- [ ] `ansible-playbook -i inventory/hosts.yml site.yml --limit moonwing_manager_primary`
- [ ] `curl -fsS https://moonwing.example.com/healthz` (or equivalent on your LAN)
- [ ] verify Postgres, Redis, MinIO (if used), API, and worker containers are healthy
```

- [ ] **Step 2: Validate inventory resolves the intended hosts**

Confirm `ansible_host` / `ansible_user` match where you intend to deploy (omit real values from forks you publish).

- [ ] **Step 3: Update inventory and compose deployment assets**

```yaml
moonwing_manager_primary:
  ansible_host: SET_ME_MANAGER_IP
```
...
Run: `ansible-playbook -i inventory/hosts.yml site.yml --tags manager --limit moonwing_manager_primary`
...
git commit -m "feat: deploy moonwing foundation"
```

## Task 12: Verification and Hardening Pass

**Files:**
- Modify: `./tests/integration/test_run_execution_flow.py`
- Modify: `./tests/unit/test_selection_rules.py`
- Modify: `./README.md`
...
- Spec coverage check: covered control API, worker execution, Postgres source of truth, local S3-compatible storage, both credential modes, explicit provider/model selection, SBOM provenance, state transitions, and Ansible/Compose deployment path.
